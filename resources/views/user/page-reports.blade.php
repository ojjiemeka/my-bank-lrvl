...
@section('content')
                ...
                <div class="position-absolute w-100" style="height:320px"><!-- same height as chart in plugins/apex/apex-call.js-->
                    <div class="card-center">
                        <h1 class="pb-5 mb-5 text-center">
                            <span class="font-25 d-block pt-4 mt-1">$525,670.15</span>
            ...
            <div class="content mt-0 mb-0">
                <a href="#" class="d-flex pb-3">
                    ...
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1 color-red-dark">$15,630.41</h4>
                ...
                <a href="#" class="d-flex pb-3">
                    ...
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1 color-green-dark">$355,030.55</h4>
                ...
                <a href="#" class="d-flex pb-3">
                    ...
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1 color-red-dark">$95,650.31</h4>
                ...
                <a href="#" class="d-flex pb-3">
                    ...
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1 color-red-dark">$2,700.31</h4>
                ...
                <a href="#" class="d-flex pb-3">
                    ...
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1 color-red-dark">$980.31</h4>
    ...
    <div id="menu-activity-single" class="offcanvas offcanvas-bottom offcanvas-detached rounded-m">
        ...
        <div class="menu-size" style="height:350px;">
            ...
            <a href="#" class="mx-3 btn btn-full gradient-highlight shadow-bg shadow-bg-s">Back to Category</a>
        </div>
    </div>
