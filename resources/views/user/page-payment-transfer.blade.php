        ...
        <div class="pt-3">
            <div class="page-title d-flex">
                <div class="align-self-center me-auto">
                    ...
                    <h1 class="color-theme">Transfer</h1>
                </div>
                    ...
                    <div class="collapse show" id="tab-16" data-bs-parent="#tab-group-6">
                        <div class="list-group list-custom list-group-m list-group-flush rounded-xs">
                            <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-request" class="list-group-item">
                                ...
                                <div><h5 class="font-15 mb-0">Dan Singer</h5><span>Never Transfered</span></div>
                            ...
                            <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-request" class="list-group-item">
                                ...
                                <div><h5 class="font-15 mb-0">Lisa Smith</h5><span>Cannot send Transfer</span></div>
                            ...
                            <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-request" class="list-group-item">
                                ...
                                <div><h5 class="font-15 mb-0">Dana Rose</h5><span>Never Transfered</span></div>
                                <span class="badge rounded-xl">TRANSFER</span>
                            </a>
                            <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-request" class="list-group-item">
                                <img src="images/pictures/16s.jpg" width="33" class="me-3 rounded-xs" alt="img">
                                <div><h5 class="font-15 mb-0">Jack Dancer</h5><span>Never Transfered</span></div>
                                <span class="badge rounded-xl">TRANSFER</span>
                            </a>
                        </div>
                    </div>
