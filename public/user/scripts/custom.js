...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function init_template() {
        ...
        //Copyright Year
        setTimeout(function () {
            var copyrightYearElements = document.querySelectorAll('.copyright-year');
    
            if(copyrightYearElements) {
                copyrightYearElements.forEach(function(element) {
                    // Set the desired year (e.g., 2023)
                    var desiredYear = 2023;
                    element.textContent = desiredYear;
                });
            }
        }, 500);
        ...
        function pageHighlights() {
            ...
            highlightData.forEach((el) =>
                el.addEventListener("click", (e) => {
                    ...
                    loadHighlight.href =
                        "styles/highlights/" + highlight + ".css";
                    document
            ...
            if (rememberHighlight) {
                ...
                loadHighlight.type = "text/css";
                loadHighlight.href =
                    "styles/highlights/" + rememberHighlight + ".css";
